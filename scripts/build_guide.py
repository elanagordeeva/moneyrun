...
CSS = """
    ...
    *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .g-hero-art{position:relative;z-index:1;align-self:end;justify-self:center;padding:1.6rem 1rem 0}
    .g-hero-art img{display:block;width:100%;max-width:230px;border-radius:26px 26px 0 0;box-shadow:0 30px 60px -22px rgba(20,45,90,.45),0 8px 20px -8px rgba(20,45,90,.25);transform:translateY(10px) rotate(-2.5deg);transform-origin:bottom center;border:1px solid rgba(255,255,255,.7)}
    @media(max-width:680px){
      .g-hero{grid-template-columns:1fr}
      .g-hero::after{background:linear-gradient(180deg,rgba(252,253,254,.92) 0%,rgba(252,253,254,.5) 60%,rgba(252,253,254,0) 100%)}
      .g-hero-art{justify-self:center;padding-top:.5rem;max-width:260px;margin:0 auto}
      .g-hero-art img{transform:translateY(10px) rotate(0)}
    }
...
<main class="legal"><div class="legal-wrap">
    ...
    <header class="g-hero">
      ...
      <div class="g-hero-art" aria-hidden="true">
        <img src="art/full_7-2.png.webp" alt="Профиль Атлета в Moneyrun" loading="eager">
      </div>
    </header>
    {content}
</div></main>
