...
CSS = """
    ...
    *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
    ...
    .legal-back{display:inline-flex;gap:.4rem;font-size:.9rem;color:var(--muted);text-decoration:none;margin-bottom:1.6rem}
    .legal-back:hover{color:var(--ink)}
    .legal h1{font-family:var(--fd);font-weight:800;font-size:clamp(1.9rem,4vw,2.8rem);letter-spacing:-.03em;line-height:1.1;margin-bottom:1rem}
    .legal-meta{color:var(--muted);font-size:.95rem;line-height:1.6;margin-bottom:1.8rem;padding-bottom:1.6rem;border-bottom:1px solid var(--border)}
...
<main class="legal"><div class="legal-wrap">
    ...
    <p class="legal-meta">Платформа Moneyrun — социально-благотворительный проект по развитию бегового движения. Версия от 16.02.26.</p>
    {content}
</div></main>
{FOOT}
{JS}
